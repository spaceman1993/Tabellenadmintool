...
.controller("TableCtrl", ['$scope', '$q', '$http', '$filter', '$timeout', 'benutzerFactory', 'activUser', 'alerts', function($scope, $q, $http, $filter, $timeout, benutzerFactory, activUser, alerts) {
	...
	var getLoginUser = function(name){
		...
		deferred.resolve($scope.getBenutzerByName());

		return deferred.promise;
	};
	
	
	var addAdminn = function(name){
	    
		var deferred = $q.defer();
		
		var einstellug = new Object();
		
		einstellug.anzeige = new Object();
		einstellug.anzeige.designauswahl = new Object();
		einstellug.anzeige.designauswahl.firstdesign = true;
		einstellug.anzeige.designauswahl.seconddesign = true;
		einstellug.anzeige.standardDesign = "1";
		einstellug.anzeige.favoritVerein = "";
		einstellug.anzeige.spielplan = "ja";
		einstellug.anzeige.verwaltung = "ja";
		
		einstellug.design = new Object();
		einstellug.design.tableDesign = new Object();
		einstellug.design.tableDesign.backgroundColorHeader = "#030094";
		einstellug.design.tableDesign.textColorHeader = "#ffffff";
		einstellug.design.tableDesign.backgroundColor = "#ffffff";
		einstellug.design.tableDesign.textColor = "#000000";
		einstellug.design.tableDesign.tableStriped = true;
		einstellug.design.tableDesign.stripedColor = "#cccccc";
		einstellug.design.tableDesign.captionColor = "#000000";
		einstellug.design.tableDesign.highlightColor = "#9ca0ff";
		einstellug.design.tableDesign.tableBordered = false;
		
		einstellug.liga = new Object();
		einstellug.liga.leagues = new Array();
		einstellug.liga.favoritLeague = new Object();

		   
		return deferred.resolve(benutzerFactory.create("admin","123123", einstellug, "crypt"));
	};
	...
	getLoginUser("admin").then(function(data) {
		admin = data;
		if(admin.name !== "admin"){
			addAdminn.then(function(data){
				admin = data;
				$scope.changepasswort = true;
			})
		}
	});
